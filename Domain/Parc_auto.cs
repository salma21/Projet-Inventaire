...
namespace Domain
{
    ...
    public partial class Parc_auto
    {
        ...
        [System.ComponentModel.DataAnnotations.Required(ErrorMessage = "Le nom du parc automobile est obligatoire")]
        [StringLength(30, MinimumLength = 3, ErrorMessage = "Le nom du parc automobile doit comporter entre 3 et 30 caractéres")]
